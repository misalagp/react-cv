...
import './Left.css';  // Import your CSS file if you have one
...
const Left = (props) => {
  ...
  useEffect(() => {
    // Check if the flowerContainerRef is not null
    if (flowerContainerRef.current) {
      // Remove the 'not-loaded' class from the body when the flower component is loaded
  ...
  return (
    <div className={`left ${loaded ? 'loaded' : 'not-loaded'}`}>
      <div className={`night ${loaded ? 'loaded' : 'not-loaded'}`} ref={flowerContainerRef}>
      <div className="left-inner">
        ...
        <div className="grow-ans" style={{ '--d': '1.2s', width: 0, height: 0 }}>
        ...
        <div className="grow-ans" style={{ '--d': '2.4s', width: 0, height: 0 }}>
          <div className="flower__g-right flower__g-right--1">
            <div className="leaf"></div>
          </div>
        </div>

        <div className="grow-ans" style={{ '--d': '2.8s', width: 0, height: 0 }}>
